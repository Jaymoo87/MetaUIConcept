...
const GetStarted = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div variants={planetVariants("left", 2.5)} className={`${styles.flexCenter} flex-1`}>
        <img src="/getstarted.png" alt="get-started" className="w-[90%] h-[90%] object-contain" />
      </motion.div>
      <motion.div variants={fadeIn("left", "tween", 0.2, 1)} className="flex-[0.75] flex justify-center flex-col">
        <TypingText title="|  What to do First" />
