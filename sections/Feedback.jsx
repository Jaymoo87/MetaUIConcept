    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[24px] mb-[14px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">
            Founder | Metaversus
          </p>
        </div>
        ...
        <p className="mt-[8px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          ...
          3.0 by using the metaverse you can use it as anything"
        </p>
      </motion.div>
      <motion.div
